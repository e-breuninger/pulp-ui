...
release workflow does not run on forks, so your copy stays untouched. See the
Releases section of the [README](README.md) for which types release what.
...
- Deployment-specific branding, hostnames or links in the templates. Those
  belong in `PULP_UI_CUSTOM_DIR` — see the Branding section of the
  [README](README.md).
